            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-5 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <span class="text-muted">Pendapatan dari Energi Surya</span>
                                <h3 class="font-bold">Rp 505,211,-</h3>
                            </div>
                        </div>
                    </div>
                    <!-- column -->
                    <div class="col-sm-12 col-md-5 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Break Even Point</h4>
                                <div style="height:230px; width:100%;" class="m-t-20 rate"></div>
                            </div>
                        </div>
                    </div>
                    <!-- column -->
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card bg-cyan">
                            <div class="card-body">
                                <h4 class="card-title text-white">Umur Panel Surya</h4>
                                <h2 class="text-white">95</h2>
                                <div class="text-center">
                                    <div id="activeu" class="m-t-30 m-b-30"></div>
                                    <span class="text-white op-5">Jumlah Hari Sejak Pemasangan</span>
                                </div>
                            </div>
                        </div>
                    </div>
